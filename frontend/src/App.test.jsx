...
describe("App", () => {
  ...
  test("renders the single-label file input and all seven application fields", () => {
    ...
    expect(screen.getByLabelText(/choose one label photo/i)).toBeInTheDocument();
    ...
    expect(screen.getByLabelText(/alcohol by volume/i)).toBeInTheDocument();
  ...
  test("submits one image plus the seven application fields to the verify endpoint", async () => {
    ...
    expect(body.get("net_contents")).toBe(FIELD_VALUES.net_contents);
